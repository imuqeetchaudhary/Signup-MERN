...
exports.register = promise(async (req, res) => {
    ...
    if (req.user.userType == "admin") {
        ...
        const message = `Hey ${body.name}! You're successfully registered with email ${body.email}. Kindly create your password using this link ${"http://localhost:8000/create-password"}`
